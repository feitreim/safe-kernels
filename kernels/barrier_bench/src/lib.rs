...
//!
//! Two copies of the tcgen05 CLC work-stealing gemm from `kernels/gemm`,
...
//!
//! The kernels share this module so both land in one `barrier_bench.ptx` and
//! run on identical descriptors/inputs. `src/main.rs` times both and
